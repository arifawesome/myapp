# Generated by Django 2.2.10 on 2020-10-09 02:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deviceImages', models.ImageField(blank=True, null=True, upload_to='Deviceimages')),
            ],
        ),
        migrations.CreateModel(
            name='UserAddress',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deviceEngraving', models.CharField(blank=True, max_length=30, null=True)),
                ('deviceImages', models.ImageField(blank=True, null=True, upload_to='Deviceimg')),
                ('trade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='guestuserdevices', to='user.GuestUserTradeInfo')),
            ],
        ),
    ]
